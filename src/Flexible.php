...
use Formfeed\NovaFlexibleContent\Layouts\LayoutInterface;
use Formfeed\NovaFlexibleContent\Layouts\Collection as LayoutsCollection;
...
class Flexible extends Field
{
     ...
     *
     * @var Formfeed\NovaFlexibleContent\Layouts\Collection
     */
    protected $layouts;
     ...
     *
     * @var Formfeed\NovaFlexibleContent\Value\ResolverInterface
     */
    protected $resolver;
     ...
     *
     * @param Formfeed\NovaFlexibleContent\Layouts\LayoutInterface $layout
     * @return void
     */
     ...
     *
     * @param  string $key
     * @return \Formfeed\NovaFlexibleContent\Layouts\Layout
     */
     ...
     *
     * @param  string $key
     * @return null|\Formfeed\NovaFlexibleContent\Http\FlexibleAttribute
     */
    ...
    protected function registerOriginModel($model)
    {
        if (is_a($model, \Laravel\Nova\Resource::class)) {
            $model = $model->model();
        } else if (is_a($model, \Formfeed\NovaPage\Pages\Template::class)) {
